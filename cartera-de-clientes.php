...
<section id="contacto" class="py-20 bg-accent">
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      ...
      <div class="bg-navy rounded-xl p-8 shadow-2xl border border-white/10 transform hover:-translate-y-1 transition-transform duration-300">
        <h3 class="text-xl font-bold mb-6 text-white border-b border-white/10 pb-4">Solicitar Información</h3>
        <div class="space-y-4">
          <a href="https://wa.me/525637713882?text=Hola,%20interesado%20en%20cartera%20de%20clientes" 
